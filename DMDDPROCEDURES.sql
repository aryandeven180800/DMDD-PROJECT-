...
--Print 'New Assigned score to the test no is : ' + cast(@Score as decimal)
	End
	EXEC [dbo].[UpdateStudentTestScoreMarks3] 27,34.0  ---CHANGES Score from assigned value
...
CREATE PROCEDURE ChangeProfessorname
	...
	End
	EXEC ChangeProfessorname Maya,103  ---CHANGES Professor Name TO Pruthvi from assigned value
